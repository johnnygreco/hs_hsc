...
def coaddCutout1Ser(prefix, root=None, pix=0.168, useBkg=True, zp=27.0, usePsf=True,
...
if __name__ == '__main__':
    ...
    coaddCutout1Ser(args.prefix, root=args.root, pix=args.pix, useBkg=args.useBkg,
            ...
            verbose=args.verbose, run=args.run)
